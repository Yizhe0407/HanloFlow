...
| 類型 | 數量 |
|------|------|
| 總詞條（active runtime） | 16,304 |
| 人工驗證（trust: human active rows） | ~7,330 |
| base seed（trust: seed，低信任） | source 仍有短詞 active；runtime 以 policy 過濾高風險 seed |
| 最新 round | round189 |

所有迴歸測試全部通過（共 792 筆）：
bus 282、medical 72、transport 62、conversation 42、restaurant 46、shopping 42、hotel 47、taxi 47、bank 41、school 33、family 40、workplace 38
