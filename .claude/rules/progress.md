...
| 類型 | 數量 |
|------|------|
| 總詞條（active runtime） | 20,101 |
| 人工驗證（trust: human active rows） | ~10,921 |
| base seed（trust: seed，低信任） | source 仍有短詞 active；runtime 以 policy 過濾高風險 seed |
| 最新 round | round366 |

所有迴歸測試全部通過（共 2381 筆）：
bus 549、medical 220、transport 269、conversation 113、restaurant 98、shopping 188、hotel 171、taxi 83、bank 146、school 110、family 88、workplace 346
