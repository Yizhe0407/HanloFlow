...
| 類型 | 數量 |
|------|------|
| 總詞條（active runtime） | 17,317 |
| 人工驗證（trust: human active rows） | ~8,151 |
| base seed（trust: seed，低信任） | source 仍有短詞 active；runtime 以 policy 過濾高風險 seed |
| 最新 round | round275 |

所有迴歸測試全部通過（共 1656 筆）：
bus 310、medical 196、transport 101、conversation 113、restaurant 98、shopping 185、hotel 165、taxi 80、bank 146、school 83、family 88、workplace 91
