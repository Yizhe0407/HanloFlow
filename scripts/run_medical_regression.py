...
MEDICAL_REGRESSION_CASES: list[RegressionCase] = [
    ...
    RegressionCase("tests", "可以幫你們安排檢查時間嗎？", "會當替恁安排檢查時間無？"),
    RegressionCase("tests", "可以幫他們安排檢查時間嗎？", "會當替怹安排檢查時間無？"),
    RegressionCase("tests", "可以幫大家安排檢查時間嗎？", "會當替逐家安排檢查時間無？"),
    RegressionCase("tests", "可以幫各位安排檢查時間嗎？", "會當替逐家安排檢查時間無？"),
    RegressionCase("tests", "可以幫客人安排檢查時間嗎？", "會當替人客安排檢查時間無？"),
    RegressionCase("tests", "可以幫病人安排檢查時間嗎？", "會當替病人安排檢查時間無？"),
    RegressionCase("tests", "可以幫家屬安排檢查時間嗎？", "會當替家屬安排檢查時間無？"),
    RegressionCase("tests", "可以協助你們安排檢查時間嗎？", "會當鬥相共恁安排檢查時間無？"),
    RegressionCase("tests", "可以協助他們安排檢查時間嗎？", "會當鬥相共怹安排檢查時間無？"),
    ...
    RegressionCase("tests", "麻煩協助我們安排檢查時間。", "麻煩鬥相共阮安排檢查時間。"),
    RegressionCase("tests", "麻煩幫我們安排檢查時間。", "麻煩替阮安排檢查時間。"),
    RegressionCase("tests", "能協助我安排檢查時間嗎？", "會當鬥相共我安排檢查時間無？"),
    RegressionCase("tests", "能協助我們安排檢查時間嗎？", "會當鬥相共阮安排檢查時間無？"),
    RegressionCase("tests", "能否麻煩您協助我安排檢查時間？", "敢會當麻煩你鬥相共我安排檢查時間？"),
    RegressionCase("tests", "能否麻煩您協助我們安排檢查時間？", "敢會當麻煩你鬥相共阮安排檢查時間？"),
    RegressionCase("tests", "能否麻煩您幫我們安排檢查時間？", "敢會當麻煩你替阮安排檢查時間？"),
    ...
    RegressionCase("tests", "能幫我們安排檢查時間嗎？", "會當替阮安排檢查時間無？"),
    RegressionCase("tests", "能否幫我安排檢查時間？", "敢會當替我安排檢查時間？"),
    RegressionCase("tests", "方便幫我安排檢查時間嗎？", "方便替我安排檢查時間無？"),
    RegressionCase("tests", "方便幫我們安排檢查時間嗎？", "方便替阮安排檢查時間無？"),
    RegressionCase("tests", "方不方便幫你們安排檢查時間？", "敢方便替恁安排檢查時間？"),
    RegressionCase("tests", "方不方便幫他們安排檢查時間？", "敢方便替怹安排檢查時間？"),
    RegressionCase("tests", "方不方便幫大家安排檢查時間？", "敢方便替逐家安排檢查時間？"),
    RegressionCase("tests", "能不能協助大家安排檢查時間？", "敢會當鬥相共逐家安排檢查時間？"),
    RegressionCase("tests", "方不方便幫各位安排檢查時間？", "敢方便替逐家安排檢查時間？"),
    RegressionCase("tests", "能不能協助各位安排檢查時間？", "敢會當鬥相共逐家安排檢查時間？"),
    RegressionCase("tests", "方不方便幫客人安排檢查時間？", "敢方便替人客安排檢查時間？"),
    RegressionCase("tests", "能不能協助客人安排檢查時間？", "敢會當鬥相共人客安排檢查時間？"),
    RegressionCase("tests", "方不方便幫病人安排檢查時間？", "敢方便替病人安排檢查時間？"),
    RegressionCase("tests", "能不能協助病人安排檢查時間？", "敢會當鬥相共病人安排檢查時間？"),
    RegressionCase("tests", "方不方便幫家屬安排檢查時間？", "敢方便替家屬安排檢查時間？"),
    RegressionCase("tests", "能不能協助家屬安排檢查時間？", "敢會當鬥相共家屬安排檢查時間？"),
    ...
    RegressionCase("tests", "可以幫藥師安排時間嗎？", "會當替藥師安排時間無？"),
    RegressionCase("tests", "可不可以幫藥師換班？", "敢會當替藥師換班？"),
    RegressionCase("tests", "可以協助藥師確認排班嗎？", "會當鬥相共藥師確認排班無？"),
    RegressionCase("tests", "可以幫藥劑師安排時間嗎？", "會當替藥劑師安排時間無？"),
    RegressionCase("tests", "可不可以幫藥劑師換班？", "敢會當替藥劑師換班？"),
    RegressionCase("tests", "可以協助藥劑師確認排班嗎？", "會當鬥相共藥劑師確認排班無？"),
    RegressionCase("tests", "方便協助我安排檢查時間嗎？", "方便鬥相共我安排檢查時間無？"),
    RegressionCase("tests", "可以請您協助我安排檢查時間嗎？", "會當請你鬥相共我安排檢查時間無？"),
    RegressionCase("tests", "可以請您協助我們安排檢查時間嗎？", "會當請你鬥相共阮安排檢查時間無？"),
    ...
    RegressionCase("doctor_flow", "可以幫醫師換班嗎？", "會當替醫師換班無？"),
    RegressionCase("doctor_flow", "可不可以幫醫師換班？", "敢會當替醫師換班？"),
    RegressionCase("doctor_flow", "請協助醫師換班。", "請鬥相共醫師換班。"),
    RegressionCase("doctor_flow", "可以幫醫生換班嗎？", "會當替醫生換班無？"),
    RegressionCase("doctor_flow", "可不可以幫醫生換班？", "敢會當替醫生換班？"),
    RegressionCase("doctor_flow", "請協助醫生換班。", "請鬥相共醫生換班。"),
