...
BUS_REGRESSION_CASES: list[RegressionCase] = [
    ...
    RegressionCase("yunlin_shuttle_routes", "荷苞山桐花公園到草嶺公園還要多久？", "荷苞山桐花公園到草嶺公園閣愛偌久？"),
    ...
    RegressionCase("yunlin_tourism_attractions", "石榴車站附近有榴中社區、新德豐碾米廠和張氏宗祠嗎？", "石榴車站附近有榴中社區、新德豐碾米廠和張氏宗祠無？"),
