...
BUS_REGRESSION_CASES: list[RegressionCase] = [
    ...
    RegressionCase("bus_time_queries", "從斗六到北港要多久？", "對斗六到北港愛偌久？"),
    ...
    RegressionCase("yunlin_shuttle_routes", "綠色隧道到古坑嘉興宮要多久？", "綠色隧道到古坑嘉興宮愛偌久？"),
    ...
    RegressionCase("yunlin_tourism_attractions", "椬梧滯洪池到好蝦冏男社和成龍濕地要多久？", "椬梧滯洪池到好蝦冏男社和成龍濕地愛偌久？"),
