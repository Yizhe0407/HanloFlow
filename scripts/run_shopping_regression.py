...
SHOPPING_REGRESSION_CASES: list[RegressionCase] = [
    ...
    RegressionCase("payment", "我需要改付款方式。", "我欲改付款方式。"),
    RegressionCase("payment", "請協助改付款方式。", "請鬥相共改付款方式。"),
    ...
    RegressionCase("payment", "我需要查付款狀態。", "我欲查付款狀態。"),
    RegressionCase("payment", "請協助查付款狀態。", "請鬥相共查付款狀態。"),
    RegressionCase("payment", "我需要確認付款狀態。", "我欲確認付款狀態。"),
    RegressionCase("payment", "我想確認付款狀態。", "我想欲確認付款狀態。"),
    RegressionCase("payment", "可以幫我確認付款狀態嗎？", "會當替我確認付款狀態無？"),
    RegressionCase("payment", "請幫我確認付款狀態。", "請替我確認付款狀態。"),
    RegressionCase("payment", "麻煩你幫我確認付款狀態。", "麻煩你替我確認付款狀態。"),
    RegressionCase("payment", "幫我確認付款狀態。", "替我確認付款狀態。"),
    RegressionCase("payment", "請協助確認付款狀態。", "請鬥相共確認付款狀態。"),
    RegressionCase("payment", "我需要補印發票。", "我欲補印發票。"),
    RegressionCase("payment", "請協助補印發票。", "請鬥相共補印發票。"),
    RegressionCase("payment", "可以協助你們補印發票嗎？", "會當鬥相共恁補印發票無？"),
    RegressionCase("payment", "可以協助他們補印發票嗎？", "會當鬥相共怹補印發票無？"),
    RegressionCase("payment", "可以協助大家補印發票嗎？", "會當鬥相共逐家補印發票無？"),
    RegressionCase("payment", "可以協助各位補印發票嗎？", "會當鬥相共逐家補印發票無？"),
    RegressionCase("payment", "可以協助客人補印發票嗎？", "會當鬥相共人客補印發票無？"),
    RegressionCase("payment", "可以協助病人補印發票嗎？", "會當鬥相共病人補印發票無？"),
    RegressionCase("payment", "可以協助家屬補印發票嗎？", "會當鬥相共家屬補印發票無？"),
    RegressionCase("payment", "請協助我補印發票。", "請鬥相共我補印發票。"),
    RegressionCase("payment", "請協助我們補印發票。", "請鬥相共阮補印發票。"),
    RegressionCase("payment", "可不可以協助我補印發票？", "敢會當鬥相共我補印發票？"),
    RegressionCase("payment", "可不可以協助我們補印發票？", "敢會當鬥相共阮補印發票？"),
    RegressionCase("payment", "可不可以請您協助我補印發票？", "敢會當請你鬥相共我補印發票？"),
    RegressionCase("payment", "可不可以請您協助我們補印發票？", "敢會當請你鬥相共阮補印發票？"),
    RegressionCase("payment", "麻煩幫我補印發票。", "麻煩替我補印發票。"),
    RegressionCase("payment", "麻煩幫我們補印發票。", "麻煩替阮補印發票。"),
    RegressionCase("payment", "請你幫我補印發票。", "請你替我補印發票。"),
    RegressionCase("payment", "請你幫我們補印發票。", "請你替阮補印發票。"),
    RegressionCase("payment", "我可以幫你們補印發票。", "我會當替恁補印發票。"),
    RegressionCase("payment", "我可以幫他們補印發票。", "我會當替怹補印發票。"),
    RegressionCase("payment", "可不可以幫我補印發票？", "敢會當替我補印發票？"),
    RegressionCase("payment", "可不可以幫我們補印發票？", "敢會當替阮補印發票？"),
    RegressionCase("payment", "可不可以幫你們補印發票？", "敢會當替恁補印發票？"),
    RegressionCase("payment", "可不可以幫他們補印發票？", "敢會當替怹補印發票？"),
    RegressionCase("payment", "可不可以幫大家補印發票？", "敢會當替逐家補印發票？"),
    RegressionCase("payment", "可不可以幫各位補印發票？", "敢會當替逐家補印發票？"),
    RegressionCase("payment", "可不可以幫客人補印發票？", "敢會當替人客補印發票？"),
    RegressionCase("payment", "可不可以幫病人補印發票？", "敢會當替病人補印發票？"),
    RegressionCase("payment", "可不可以幫家屬補印發票？", "敢會當替家屬補印發票？"),
    RegressionCase("payment", "能幫我補印發票嗎？", "會當替我補印發票無？"),
    RegressionCase("payment", "能否幫我補印發票？", "敢會當替我補印發票？"),
    RegressionCase("payment", "方便幫我補印發票嗎？", "方便替我補印發票無？"),
    RegressionCase("payment", "可否麻煩您幫我補印發票？", "敢會當麻煩你替我補印發票？"),
    RegressionCase("payment", "可否麻煩您幫我們補印發票？", "敢會當麻煩你替阮補印發票？"),
    RegressionCase("payment", "能麻煩您協助我補印發票嗎？", "會當麻煩你鬥相共我補印發票無？"),
    RegressionCase("payment", "能麻煩您協助我們補印發票嗎？", "會當麻煩你鬥相共阮補印發票無？"),
    RegressionCase("payment", "可不可以麻煩你幫我補印發票？", "敢會當麻煩你替我補印發票？"),
    RegressionCase("payment", "拜託幫我補印發票。", "拜託替我補印發票。"),
    RegressionCase("payment", "需要您幫我補印發票。", "需要你替我補印發票。"),
    RegressionCase("payment", "是否方便幫我補印發票？", "敢方便替我補印發票？"),
    RegressionCase("payment", "能不能協助大家確認付款狀態？", "敢會當鬥相共逐家確認付款狀態？"),
    RegressionCase("payment", "能不能協助各位確認付款狀態？", "敢會當鬥相共逐家確認付款狀態？"),
    RegressionCase("payment", "能不能協助客人確認付款狀態？", "敢會當鬥相共人客確認付款狀態？"),
    RegressionCase("payment", "能不能協助病人確認付款狀態？", "敢會當鬥相共病人確認付款狀態？"),
    RegressionCase("payment", "能不能協助家屬確認付款狀態？", "敢會當鬥相共家屬確認付款狀態？"),
    ...
    RegressionCase("after_sales", "可以幫我取消訂單嗎？", "會當替我取消訂單無？"),
    RegressionCase("after_sales", "可以退款嗎？", "會當退錢無？"),
    RegressionCase("after_sales", "可以幫我退款嗎？", "會當替我退錢無？"),
    RegressionCase("after_sales", "可以幫我退費嗎？", "會當替我退錢無？"),
    RegressionCase("after_sales", "可以幫我退貨嗎？", "會當替我退貨無？"),
    RegressionCase("after_sales", "我想退費。", "我想欲退錢。"),
    RegressionCase("after_sales", "我需要退費。", "我欲退錢。"),
    ...
    RegressionCase("after_sales", "我需要改送貨時間。", "我欲改送貨時間。"),
    RegressionCase("after_sales", "請協助改送貨時間。", "請鬥相共改送貨時間。"),
    RegressionCase("after_sales", "我需要確認送貨時間。", "我欲確認送貨時間。"),
    RegressionCase("after_sales", "我想確認送貨時間。", "我想欲確認送貨時間。"),
    RegressionCase("after_sales", "可以幫我確認送貨時間嗎？", "會當替我確認送貨時間無？"),
    RegressionCase("after_sales", "請幫我確認送貨時間。", "請替我確認送貨時間。"),
    RegressionCase("after_sales", "麻煩你幫我確認送貨時間。", "麻煩你替我確認送貨時間。"),
    RegressionCase("after_sales", "幫我確認送貨時間。", "替我確認送貨時間。"),
    RegressionCase("after_sales", "請協助確認送貨時間。", "請鬥相共確認送貨時間。"),
    RegressionCase("after_sales", "請協助查送貨時間。", "請鬥相共查送貨時間。"),
    ...
    RegressionCase("after_sales", "請協助取消出貨。", "請鬥相共取消出貨。"),
    ...
    RegressionCase("after_sales", "我需要申請退貨。", "我欲申請退貨。"),
    RegressionCase("after_sales", "請協助申請退貨。", "請鬥相共申請退貨。"),
    RegressionCase("after_sales", "請協助申請退費。", "請鬥相共申請退錢。"),
    RegressionCase("after_sales", "請協助申請退款。", "請鬥相共申請退錢。"),
